...
class TopicProcessor:
    def __init__(self, category, file):
        ...
        self.json_save_path = f'demo2/V2_prompt/result_json_zhipu_{self.category}_demo2.json'
        self.ques_save_path = f'demo2/V2_prompt/result_{self.category}_demo2.txt'
        self.topic_options = []
        self.client = OpenAI(
                            api_key = "xxx",
...
if __name__ == "__main__":
    ...
    file_dict = {
        ...
        "科技": "demo2/V2_prompt/qq_tech_sm.txt",
